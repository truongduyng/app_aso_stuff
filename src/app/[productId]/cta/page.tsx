...
export default function CtaPage() {
  ...
  const allSlides =
    platform === "android" && localizedSlides.android?.length
      ? localizedSlides.android
      : localizedSlides.iphone;
  const uniquePaths = [
    ...new Set(allSlides.map((s) => s.imagePath).filter(Boolean) as string[]),
  ];
  ...
  const headline =
    ...
    product.name;
  const subheadline =
    product.metadataByLocale?.[locale]?.subtitle ?? product.metadata?.subtitle;
  ...
  return (
    <div style={{ padding: "24px 24px 32px", maxWidth: 680, margin: "0 auto" }}>
      ...
      >
        {(
          [
            { value: ctaSc1, onChange: setCtaSc1, label: "left" },
            { value: ctaSc2, onChange: setCtaSc2, label: "right" },
          ] as const
          ...
          <div key={label} style={selectWrapStyle}>
            ...
            >
              <path
                d="M2 4l4 4 4-4"
                stroke={chrome.light ? "#667085" : "#aaa"}
                strokeWidth={1.5}
                strokeLinecap="round"
        ...
        <div
          style={{
            ...
            gap: 2,
            height: 34,
            background: ratioToggleBg,
            borderRadius: 8,
            padding: 3,
            border: `1px solid ${ratioToggleBorder}`,
          }}
        >
        ...
        <ExportPngButton
          ...
          onClick={async () => {
            ...
            await exportCtaImage(
              offscreenRef.current,
              CTA_W,
              ctaH,
              `${product.id}-cta-${CTA_W}x${ctaH}.png`,
            );
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
        ...
        <button
          ...
          style={{
            ...
            minWidth: 80,
            boxShadow:
              saveState === "saving" ? "none" : "0 1px 3px rgba(0,0,0,0.18)",
      ...
      <div
        style={{
          ...
          background: T.bg,
          boxShadow: chrome.previewShadow,
        }}
      >
        <div
          style={{
